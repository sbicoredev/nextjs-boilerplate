  ...
  matcher: [
    {
       ...
       * - favicon.ico, sitemap.xml, robots.txt, manifest, icon (metadata files)
       */
      source:
        "/((?!api|_next/static|_next/image|favicon.ico|assets|sitemap.xml|robots.txt|manifest|icon|.well-known).*)",
      missing: [
